...
function atmMachineUsername() {
	username = document.getElementById("username").innerHTML = "Enter your name";
...
function atmMachinePassword() {
	var pswEntry = parseInt(document.getElementById("password").innerHTML = "Dear " + username + ", enter your 4 digit PIN");
